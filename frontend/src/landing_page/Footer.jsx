    ...
    <div>
            <div className="footer " >
                ...
                <div className="row">
                    ...
                    <div className="col-8">
                                        <a href=''className='me-2 text-muted fs-6'>NSE                      </a>
                                        <a href=''className='me-2 text-muted fs-6'>BSE </a>
                                        <a href=''className='me-2 text-muted fs-6'>MCX </a>
                                        <a href=''className='me-2 text-muted fs-6'>Terms & conditions </a>
                                        <a href=''className='me-2 text-muted fs-6'>Policies & procedures </a>
                                        <a href=''className='me-2 text-muted fs-6'>Privacy policy </a>
                                        <a href=''className='me-2 text-muted fs-6'>Disclosure </a>
                                        <a href=''className='me-2 text-muted fs-6'>For investor's attention </a>
                                        <a href=''className='me-2 text-muted fs-6'>Investor charter</a>
